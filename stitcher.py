...
if __name__ == "__main__":
    ...
    image00 = Image.open("%s/%s" % (argv[1], '0-0.jpg'));
    image01 = Image.open("%s/%s" % (argv[1], '0-1.jpg'));
    image02 = Image.open("%s/%s" % (argv[1], '0-2.jpg'));
    image10 = Image.open("%s/%s" % (argv[1], '1-0.jpg'));
    image11 = Image.open("%s/%s" % (argv[1], '1-1.jpg'));
    image12 = Image.open("%s/%s" % (argv[1], '1-2.jpg'));
    image20 = Image.open("%s/%s" % (argv[1], '2-0.jpg'));
    image21 = Image.open("%s/%s" % (argv[1], '2-1.jpg'));
    image22 = Image.open("%s/%s" % (argv[1], '2-2.jpg'));
    image30 = Image.open("%s/%s" % (argv[1], '3-0.jpg'));
    image31 = Image.open("%s/%s" % (argv[1], '3-1.jpg'));
    image32 = Image.open("%s/%s" % (argv[1], '3-2.jpg'));
